import { Box, Container, Divider, Grid, Grid2, Stack, Typography } from "@mui/material";
...
import PapularBrands from "./components/papularBrands";
            ...
            <Container maxWidth='lg'>
                ...
                <Stack spacing={3} mt={3}>
                    ...
                    <Stack sx={{
                        ...
                        <PapularBrands {...{ brands: papularBrands }} />
                    </Stack>
                </Stack>
            </Container>
        </Stack>
